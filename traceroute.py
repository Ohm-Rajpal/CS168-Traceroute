...
class IPv4:
    ...
    def __init__(self, buffer: bytes):
        buf = bitstring_convert(buffer)
        self.version = int(buf[:4], 2)
        self.header_len = int(buf[4:8], 2) * 4
        self.tos = int(buf[8:16], 2)
        self.length = int(buf[16:32], 2)
...
class ICMP:
    ...
    def __init__(self, buffer: bytes):
        buf = bitstring_convert(buffer)
        self.type = int(buf[:8], 2)
        self.code = int(buf[8:16], 2)
        self.cksum = int(buf[16:32], 2)
...
class UDP:
    ...
    def __init__(self, buffer: bytes):
        buf = bitstring_convert(buffer)
        self.src_port = int(buf[:16], 2)
        self.dst_port = int(buf[16:32], 2)
        self.len = int(buf[32:48], 2)
        self.cksum = int(buf[48:64], 2)
...
def bitstring_convert(buffer):
    """
    Converts buffer into a bitstring
    """
